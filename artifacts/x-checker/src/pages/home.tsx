        ...
        extraSchemas={[
          {
            ...
            "@type": "WebSite",
            "url": "https://www.xtoolkit.live",
            "name": "X Toolkit",
            "description": "Free online tools for X (Twitter), SEO, developers and creators.",
            "potentialAction": {
              "@type": "SearchAction",
              "target": { "@type": "EntryPoint", "urlTemplate": "https://www.xtoolkit.live/tools?q={search_term_string}" },
          ...
          },
          {
            ...
            "name": "X Toolkit",
            "url": "https://www.xtoolkit.live",
            "logo": { "@type": "ImageObject", "url": "https://www.xtoolkit.live/favicon-512.png" },
